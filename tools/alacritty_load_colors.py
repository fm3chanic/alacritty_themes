...
# the target file is "alacritty_theme_template.toml"
# you can find this template in https://github.com/fm3chanic/alacritty_themes
...
f = open('alacritty_theme_template.toml', 'r', encoding='utf-8')
content = f.read()
f.close()
